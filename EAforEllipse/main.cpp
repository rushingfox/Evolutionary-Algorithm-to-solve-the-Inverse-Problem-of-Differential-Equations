...
int main()
{
    ...
    fout_statis << "次数" << " " << "1.1REQ" << " " << "1.1REU" << " " << "1.1time" << " " << "1.2REQ" << " " << "1.2REU" << " " << "1.2time" << " " << "1.3REQ" << " " << "1.3REU" << " " << "1.3time" << " " << "2.1REQ" << " " << "2.1REU" << " " << "2.1time" << " " << "2.2REQ" << " " << "2.2REU" << " " << "2.2time" <<" " << "2.3REQ" << " " << "2.3REU" << " " << "2.3time" << endl;
    ...
    for (int test_num_real = 0; test_num_real < test_num; test_num_real++)
    {
        ...
        */
        ...
        cout << "运行回合数：" << loop_num_real << endl;
        cout << "REQ:" << Group->REQ << "REU:" << Group->REU << endl;
        cout << "第一加第二加第三回合运行时间" << (double)(end - start) / CLOCKS_PER_SEC << endl;
        fout_statis << Group->REQ << " " << Group->REU << " ";
        fout_statis << (double)(end - start) / CLOCKS_PER_SEC << " ";
